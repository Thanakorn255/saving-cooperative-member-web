              ...
              return (
                <tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    ...
                    } else if (cell.column.Header === "Period") {
                      data = (
                        <p className="text-sm font-bold text-navy-700 dark:text-white ml-2">
                          {cell.value}
                        </p>
                      );
                    } else if (cell.column.Header === "Settle") {
                      data = (
                        <p className="text-sm font-bold text-navy-700 dark:text-white ml-2">
                    ...
                    else if (cell.column.Header === "Pay") {
                      data = (
                        <p className="text-sm font-bold text-navy-700 dark:text-white ml-2">
                        {cell.value}
                      </p>
                    ...
                    else if (cell.column.Header === "AccruedInterest") {
                      data = (
                        <p className="text-sm font-bold text-navy-700 dark:text-white ml-2">
                        {cell.value}
                      </p>
